...
export const Edit = _ => {
  ...
  , { to: '/member/connections', title: 'Connections' } 
  ];
...
export const Connections = ({ member: { id } = {} }) => {
  const items = [ 
    { to: '/member/connections', title: 'Manage Connections' } 
  , { to: '/member/connections/add', title: 'Connect', claim: `manage ${id}` } 
  ];
