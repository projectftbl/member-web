  ...
  render() {
    ...
    return (
      <span>
        ...
        {equity && <Field value={equity.description} description='Your Founder Bonus Percentage (equity) is as follows:' />}
        {special && <Field Field={TextArea} value={special} rows={4} description='You agree to provide FTBL the following promotional benefits (marketing rights):' />}
      </span>
    );
  }
};
