  ...
  render() {
    ...
    return (
      <Form onSubmit={handleSubmit} authorized={authorized}>
        ...
        <Additional additional={fields.additional} />
...
export default reduxForm({ 
  form: 'profile'
, fields: [ 'name', 'type', 'bio', 'additional.content', 'additional.existing', 'additional.term', 'additional.equity', 'additional.special' ]
, validate })(Profile);
