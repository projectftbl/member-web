...
import { Heading, Rule } from '@recipher/component';
import { Spinner, Warning, Err } from '@recipher/icons';
  ...
  render() {
    ...
    return (
      <div data-test='connect-form'>
        ...
        <Icon authorized={authorized} network='facebook' onConnect={connectTo} />
