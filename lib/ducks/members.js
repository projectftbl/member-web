...
export default function reducer(state = initialState, action) {
  ...
  case UPDATE_SUCCESS:
  case CREATE_SUCCESS:
    return assign({}, state, { data: action.meta.setPrimary ? union([ action.payload.result ], state.data) : state.data
                             , primary: action.meta.setPrimary && action.payload.result
...
export function create(data, options = { setPrimary: true }) {
