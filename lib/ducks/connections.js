...
export default function reducer(state = initialState, action) {
  ...
  case FETCH_SUCCESS:
    return assign({}, state, { data: action.payload.result, fetching: false, isFetched: true });

  case FETCH_FAILED:
    return assign({}, state, { fetching: false, isFetched: true });
  ...
  case REMOVE_SUCCESS:
    return assign({}, state, { disconnecting: false, data: without(state.data, action.meta.account.id) });
