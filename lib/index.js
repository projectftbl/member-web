...
export { connectionSelector
       , fetch as fetchConnections
       , list as listConnections
       , add as addConnection, remove as removeConnection } from './ducks/accounts';
...
export { FETCH as FETCH_CONNECTIONS, FETCH_SUCCESS as FETCH_CONNECTIONS_SUCCESS, FETCH_FAILED as FETCH_CONNECTIONS_FAILED
       ...
       , REMOVE as REMOVE_CONNECTION, REMOVE_SUCCESS as REMOVE_CONNECTION_SUCCESS, REMOVE_FAILED as REMOVE_CONNECTION_FAILED } from './ducks/accounts';
