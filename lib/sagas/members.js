...
import { signOn, SIGN_ON_SUCCESS, RELOAD_SUCCESS, VERIFY_SUCCESS } from '@recipher/session-web';
...
export function* update() {
  while(true) {
    ...
    const message = meta.data.accepted ? 'You have successfully signed up.' : 'The member information has been updated.';

    yield put(info(message));
  }
};
